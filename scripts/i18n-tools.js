...
const SUPPLEMENTAL_TRANSLATIONS = {
  ...
  'Storage Volumes': { fa: 'فضاهای ذخیره‌سازی (Volumes)', ar: 'وحدات التخزين (Volumes)', tr: 'Depolama Alanları (Volumes)', zh: '云硬盘存储 (Volumes)', ru: 'Дисковые хранилища (Volumes)' },
  'Volume Name': { fa: 'نام دیسک ذخیره‌سازی', ar: 'اسم وحدة التخزين', tr: 'Disk Adı', zh: '存储卷名称', ru: 'Имя диска' },
  'Size (GB)': { fa: 'حجم (گیگابایت)', ar: 'الحجم (جيجابايت)', tr: 'Boyut (GB)', zh: '容量 (GB)', ru: 'Размер (ГБ)' },
  'Create Volume': { fa: 'ایجاد فضای ذخیره‌سازی', ar: 'إنشاء وحدة تخزين', tr: 'Depolama Alanı Oluştur', zh: '创建存储卷', ru: 'Создать диск' },
  'Storage volume created.': { fa: 'فضای ذخیره‌سازی با موفقیت ایجاد شد.', ar: 'تم إنشاء وحدة التخزين بنجاح.', tr: 'Depolama alanı başarıyla oluşturuldu.', zh: '存储卷创建成功。', ru: 'Диск успешно создан.' },
  'Storage volume created successfully.': { fa: 'فضای ذخیره‌سازی با موفقیت ایجاد شد.', ar: 'تم إنشاء وحدة التخزين بنجاح.', tr: 'Depolama alanı başarıyla oluşturuldu.', zh: '存储卷创建成功。', ru: 'Диск успешно создан.' },
  'Volume deleted.': { fa: 'فضای ذخیره‌سازی حذف شد.', ar: 'تم حذف وحدة التخزين.', tr: 'Depolama alanı silindi.', zh: '存储卷已删除。', ru: 'Диск удален.' },
  'Volume deleted successfully.': { fa: 'فضای ذخیره‌سازی حذف شد.', ar: 'تم حذف وحدة التخزين.', tr: 'Depolama alanı silindi.', zh: '存储卷已删除。', ru: 'Диск удален.' },
  'Volume attached.': { fa: 'دیسک به سرور متصل شد.', ar: 'تم توصيل وحدة التخزين بالخادم.', tr: 'Disk sunucuya bağlandı.', zh: '存储卷已挂载至服务器。', ru: 'Диск подключен к серверу.' },
  'Volume attached to server.': { fa: 'دیسک به سرور متصل شد.', ar: 'تم توصيل وحدة التخزين بالخادم.', tr: 'Disk sunucuya bağlandı.', zh: '存储卷已挂载至服务器。', ru: 'Диск подключен к серверу.' },
  'Volume detached from server.': { fa: 'دیسک از سرور جدا شد.', ar: 'تم فصل وحدة التخزين عن الخادم.', tr: 'Disk sunucudan ayrıldı.', zh: '存储卷已从服务器卸载。', ru: 'Диск отключен от сервера.' },
  'Private Networks (VPC)': { fa: 'شبکه‌های خصوصی (VPC)', ar: 'الشبكات الخاصة (VPC)', tr: 'Özel Ağlar (VPC)', zh: '私有专有网络 (VPC)', ru: 'Частные сети (VPC)' },
  'VPC Name': { fa: 'نام شبکه خصوصی', ar: 'اسم الشبكة الخاصة', tr: 'VPC Adı', zh: 'VPC 名称', ru: 'Имя сети VPC' },
  'Private network created.': { fa: 'شبکه خصوصی با موفقیت ایجاد شد.', ar: 'تم إنشاء الشبكة الخاصة بنجاح.', tr: 'Özel ağ oluşturuldu.', zh: '私有网络创建成功。', ru: 'Частная сеть создана.' },
  'Private network deleted.': { fa: 'شبکه خصوصی حذف شد.', ar: 'تم حذف الشبكة الخاصة.', tr: 'Özel ağ silindi.', zh: '私有网络已删除。', ru: 'Частная сеть удалена.' },
  'Firewalls & Security Groups': { fa: 'فایروال‌ها و گروه‌های امنیتی', ar: 'جدران الحماية ومجموعات الأمان', tr: 'Güvenlik Duvarları ve Güvenlik Grupları', zh: '防火墙与安全组', ru: 'Брандмауэры и группы безопасности' },
  'Firewall Name': { fa: 'نام فایروال', ar: 'اسم جدار الحماية', tr: 'Güvenlik Duvarı Adı', zh: '防火墙名称', ru: 'Имя брандмауэра' },
  'Firewall created.': { fa: 'فایروال با موفقیت ایجاد شد.', ar: 'تم إنشاء جدار الحماية بنجاح.', tr: 'Güvenlik duvarı oluşturuldu.', zh: '防火墙创建成功。', ru: 'Брандмауэр создан.' },
  'Firewall rule added.': { fa: 'قانون امنیتی فایروال افزوده شد.', ar: 'تمت إضافة قاعدة جدار الحماية.', tr: 'Güvenlik duvarı kuralı eklendi.', zh: '防火墙规则添加成功。', ru: 'Правило брандмауэра добавлено.' },
  'rules': { fa: 'قانون', ar: 'قواعد', tr: 'kural', zh: '条规则', ru: 'правил' },
  'No volumes found.': { fa: 'فضای ذخیره‌سازی یافت نشد.', ar: 'لم يتم العثور على وحدات تخزين.', tr: 'Depolama alanı bulunamadı.', zh: '未找到存储卷。', ru: 'Диски не найдены.' },
  'Select VM': { fa: 'انتخاب سرور ابری', ar: 'اختر خادم افتراضي', tr: 'Sanal Sunucu Seçin', zh: '选择云服务器', ru: 'Выберите ВМ' },
  'Attach': { fa: 'اتصال دیسک', ar: 'توصيل', tr: 'Bağla', zh: '挂载', ru: 'Подключить' },
  'Detach': { fa: 'جداسازی', ar: 'فصل', tr: 'Ayrıl', zh: '卸载', ru: 'Отключить' },
  'Add Firewall Rule': { fa: 'افزودن قانون به فایروال', ar: 'إضافة قاعدة جدار حماية', tr: 'Güvenlik Duvarı Kuralı Ekle', zh: '添加防火墙规则', ru: 'Добавить правило брандмауэра' },
  'Add Rule': { fa: 'ثبت قانون', ar: 'إضافة قاعدة', tr: 'Kural Ekle', zh: '添加规则', ru: 'Добавить правило' },
